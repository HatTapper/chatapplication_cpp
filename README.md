...
A server-client chat application written in C++ that utilizes the Windows library and Winsock to create a direct TCP connection between multiple connected clients.
