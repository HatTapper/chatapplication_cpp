...
The files for the server and client can be found in their respective folder. Compiling the program requires version 2.2 of Winsock in order to run as intended.
